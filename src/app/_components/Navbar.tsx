...
const Navbar = () => {
  ...
  const [cartItems, setCartItems] = useState<CartItem[]>([
    { id: "1", name: "وینستون", image: "/img/winston.png", quantity: 2, price: 325000 },
    { id: "2", name: "وینستون", image: "/img/winston.png", quantity: 2, price: 325000 },
    { id: "3", name: "وینستون", image: "/img/winston.png", quantity: 2, price: 325000 },
  ]);
    ...
    <>
      ...
      <BottomSheet isOpen={isCartOpen} onClose={() => setIsCartOpen(false)}>
        <div className="py-4 px-3">
          ...
          {cartItems.length > 0 ? (
            <>
              <Typography variant="label/sm" weight="normal" className="mb-4 text-center">
      ...
      <BottomSheet isOpen={isOrderConfirmationOpen} onClose={handleCloseOrderConfirmation}>
        <OrderConfirmation 
